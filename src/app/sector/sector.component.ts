...
export class SectorComponent {
  @Input() sector: any;
  @Input() sectorName: any;
  @Input() sectorIndex: any;
  @Input() sectorNum: any;
  ...
  private setChart(): void{
    ...
    for (let i =0; i<this.rowData1.length; i++){
      this.pieChartLabels.push(this.rowData1[i]['Ticker'])
      newData.push(parseFloat(this.rowData1[i]['Weight']))
      tot +=parseFloat(this.rowData1[i]['Weight']);
    }
  ...
  async setMonteCarlo(): Promise<void>{
    ...
    for(let i = 0; i < this.rowData1.length; i++){
      ...
      let ticker = this.rowData1[i]['Ticker']
      let log_returns:any = []
