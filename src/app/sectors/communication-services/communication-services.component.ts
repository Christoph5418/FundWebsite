...
@Component({
  selector: 'app-communication-services',
  templateUrl: './communication-services.component.html',
  styleUrls: ['./communication-services.component.css']
})

export class CommunicationServicesComponent {
  sector: any = "COM";
  sectorName: any = "Communication Services";
  sectorIndex: any = 'XLC';
  sectorNum: any = '110';
