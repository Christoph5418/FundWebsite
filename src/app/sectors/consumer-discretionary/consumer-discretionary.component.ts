...
@Component({
  selector: 'app-consumer-discretionary',
  templateUrl: './consumer-discretionary.component.html',
  styleUrls: ['./consumer-discretionary.component.css']
})


export class ConsumerDiscretionaryComponent {
  sector: any = "CD";
  sectorName: any = "Consumer Discretionary";
  sectorIndex: any = 'XLY';
  sectorNum: any = '111';
